...
int osip_cseq_init(osip_cseq_t **cseq) {
...
char *osip_cseq_get_number(osip_cseq_t *cseq) {
  return cseq->number;
}

char *osip_cseq_get_method(osip_cseq_t *cseq) {
  return cseq->method;
}

void osip_cseq_set_number(osip_cseq_t *cseq, char *number) {
  cseq->number = (char *) number;
}

void osip_cseq_set_method(osip_cseq_t *cseq, char *method) {
...
/* returns null on error. */
int osip_cseq_to_str(const osip_cseq_t *cseq, char **dest) {
  size_t len;
...
void osip_cseq_free(osip_cseq_t *cseq) {
  if (cseq == NULL)
    return;
...
int osip_cseq_clone(const osip_cseq_t *cseq, osip_cseq_t **dest) {
  int i;
  osip_cseq_t *cs;
