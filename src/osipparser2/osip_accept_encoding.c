...
int osip_accept_encoding_parse(osip_accept_encoding_t *accept_encoding, const char *hvalue) {
  int i;
...
int osip_accept_encoding_to_str(const osip_accept_encoding_t *accept_encoding, char **dest) {
  char *buf;
  char *tmp;
  size_t len;
...
int osip_accept_encoding_clone(const osip_accept_encoding_t *ctt, osip_accept_encoding_t **dest) {
  int i;
...
void osip_accept_encoding_set_element(osip_accept_encoding_t *ae, char *element) {
  ae->element = element;
}
