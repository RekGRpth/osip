...
*/
int osip_authentication_info_parse(osip_authentication_info_t *ainfo, const char *hvalue) {
...
char *osip_authentication_info_get_auth_type(osip_authentication_info_t *authentication_info) {
  return authentication_info->auth_type;
}

void osip_authentication_info_set_auth_type(osip_authentication_info_t *authentication_info, char *auth_type) {
  authentication_info->auth_type = (char *) auth_type;
}

char *osip_authentication_info_get_nextnonce(osip_authentication_info_t *authentication_info) {
  return authentication_info->nextnonce;
}

void osip_authentication_info_set_nextnonce(osip_authentication_info_t *authentication_info, char *nextnonce) {
  authentication_info->nextnonce = (char *) nextnonce;
}

char *osip_authentication_info_get_cnonce(osip_authentication_info_t *authentication_info) {
  return authentication_info->cnonce;
}

void osip_authentication_info_set_cnonce(osip_authentication_info_t *authentication_info, char *cnonce) {
  authentication_info->cnonce = (char *) cnonce;
}

char *osip_authentication_info_get_rspauth(osip_authentication_info_t *authentication_info) {
  return authentication_info->rspauth;
}

void osip_authentication_info_set_rspauth(osip_authentication_info_t *authentication_info, char *rspauth) {
  authentication_info->rspauth = (char *) rspauth;
}

char *osip_authentication_info_get_nonce_count(osip_authentication_info_t *authentication_info) {
  return authentication_info->nonce_count;
}

void osip_authentication_info_set_nonce_count(osip_authentication_info_t *authentication_info, char *nonce_count) {
...
void osip_authentication_info_set_qop_options(osip_authentication_info_t *authentication_info, char *qop_options) {
  authentication_info->qop_options = (char *) qop_options;
}

char *osip_authentication_info_get_snum(osip_authentication_info_t *authentication_info) {
  return authentication_info->snum;
}

void osip_authentication_info_set_snum(osip_authentication_info_t *authentication_info, char *snum) {
  authentication_info->snum = (char *) snum;
}

char *osip_authentication_info_get_srand(osip_authentication_info_t *authentication_info) {
  return authentication_info->srand;
}

void osip_authentication_info_set_srand(osip_authentication_info_t *authentication_info, char *srand) {
  authentication_info->srand = (char *) srand;
}

char *osip_authentication_info_get_targetname(osip_authentication_info_t *authentication_info) {
  return authentication_info->targetname;
}

void osip_authentication_info_set_targetname(osip_authentication_info_t *authentication_info, char *targetname) {
  authentication_info->targetname = (char *) targetname;
}

char *osip_authentication_info_get_realm(osip_authentication_info_t *authentication_info) {
  return authentication_info->realm;
}

void osip_authentication_info_set_realm(osip_authentication_info_t *authentication_info, char *realm) {
  authentication_info->realm = (char *) realm;
}

char *osip_authentication_info_get_opaque(osip_authentication_info_t *authentication_info) {
  return authentication_info->opaque;
}

void osip_authentication_info_set_opaque(osip_authentication_info_t *authentication_info, char *opaque) {
...
/* returns null on error. */
int osip_authentication_info_to_str(const osip_authentication_info_t *ainfo, char **dest) {
  size_t len;
  char *tmp, *start;
...
void osip_authentication_info_free(osip_authentication_info_t *authentication_info) {
...
int osip_authentication_info_clone(const osip_authentication_info_t *ainfo, osip_authentication_info_t **dest) {
  int i;
