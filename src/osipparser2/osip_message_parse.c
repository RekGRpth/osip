...
static int __osip_message_startline_parseresp(osip_message_t *dest, const char *buf, const char **headers) {
...
static int _osip_message_parse(osip_message_t *sip, const char *buf, size_t length, int sipfrag) {
  int i;
